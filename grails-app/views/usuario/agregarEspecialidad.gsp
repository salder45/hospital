...
<body>
<g:form action="guardarEspecialidad" >
  <div class="fieldcontain ${hasErrors(bean: especialidad, field: 'nombre', 'error')} required">
    ...
    <g:hiddenField id="doctor" name="doctor" value="${doctor.id}"/>
  ...
  <fieldset class="buttons">
    <g:submitButton name="Guardar" class="save" value="${message(code: 'save', default: 'Guardar')}" />
  </fieldset>
</g:form>
